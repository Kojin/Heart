      ...
      <MDBContainer id="message" className="py-5 my-5 text-center">
        {this.props.location.pathname === "/about" && (
          <div className="text-left mt-5">
            ...
            <p>
              <strong>{ABOUT_PLACEHOLDER.company}</strong>
              <br />
              Tel: {ABOUT_PLACEHOLDER.phone}
              <br />
              {ABOUT_PLACEHOLDER.address}
              <br />
              {ABOUT_PLACEHOLDER.zip} {ABOUT_PLACEHOLDER.city}
              <br />
              <MDBBtn color="orange" href={`mailto:${ABOUT_PLACEHOLDER.mail}`}>
